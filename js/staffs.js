...
// create staff rows
function createStaffRow(name, position, city, id, date, salary) {
    var row = $("<tr>");
    $("<td>").text(name).appendTo(row);
    $("<td>").text(position).appendTo(row);
    $("<td>").text(city).appendTo(row);
    $("<td>").text(id).appendTo(row);
    $("<td>").text(date).appendTo(row);
    $("<td>").text(salary).appendTo(row);
...
function displayStaffList() {
    ...
    dataSet.forEach(staff => {
        var row = createStaffRow(...staff);
        table.append(row);
    });

    $("#staff-list").empty().append(table);
}
// event listener for sort selections
